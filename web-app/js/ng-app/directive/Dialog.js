 ...
 */
    .factory('$dialogs',['$modal',function($modal){
        return {
            error : function(header,msg, staticP){
                return $modal.open({
                    templateUrl : '/dialogs/error.html',
                    controller : 'errorDialogCtrl',
                    backdrop: (staticP ? 'static' : true),
                    keyboard: (staticP ? false: true),
                    resolve : {
            ...
            wait : function(header,msg,progress,staticP){
                return $modal.open({
            ...
            notify : function(header,msg,staticP){
                return $modal.open({
            ...
            confirm : function(header,msg,staticP){
                return $modal.open({
